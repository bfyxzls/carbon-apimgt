...
public class SubscriptionValidationSQLConstants {
    ...
    public static final String GET_API_BY_UUID_SQL =
            "SELECT " +
                    "AM_API.API_PROVIDER,AM_API.API_NAME,AM_API.API_DISPLAY_NAME,AM_API.CONTEXT, AM_API.CONTEXT_TEMPLATE, AM_API.API_UUID, " +
    ...
    public static final String GET_ALL_APIS_BY_ORGANIZATION_AND_DEPLOYMENT_SQL = "SELECT AM_API.API_PROVIDER,AM_API" +
            ".API_NAME,AM_API.API_DISPLAY_NAME,AM_API.CONTEXT, AM_API.CONTEXT_TEMPLATE, AM_API.API_UUID,AM_API.API_ID,AM_API.API_TIER,AM_API.API_VERSION,AM_API" +
    ...
    public static final String  GET_API_BY_CONTEXT_AND_VERSION_SQL = "SELECT AM_API.API_PROVIDER, AM_API.API_NAME, " +
            "AM_API.API_DISPLAY_NAME, AM_API.CONTEXT, AM_API.CONTEXT_TEMPLATE, AM_API.API_UUID, AM_API.API_ID,AM_API.API_TIER, " +
