...
import static org.wso2.carbon.apimgt.gateway.utils.MCPUtils.PROTOCOL_VERSION_2025_JUNE;
import static org.wso2.carbon.apimgt.gateway.utils.MCPUtils.PROTOCOL_VERSION_REQUESTED;
import static org.wso2.carbon.apimgt.gateway.utils.MCPUtils.PROTOCOL_VERSION_SUPPORTED;
import static org.wso2.carbon.apimgt.gateway.utils.MCPUtils.SUPPORTED_PROTOCOL_VERSIONS;
...
public class MCPPayloadGenerator {
    ...
    public static String getInitializeResponse(Object id, String serverName, String serverVersion,
        ...
        result.setProtocolVersion(PROTOCOL_VERSION_2025_JUNE);
    ...
    public static JsonObject getInitializeErrorBody(String requestedVersion) {
        ...
        data.addProperty(PROTOCOL_VERSION_REQUESTED, requestedVersion);
        JsonArray supportedVersions = new JsonArray();
        for (String version : SUPPORTED_PROTOCOL_VERSIONS) {
            supportedVersions.add(version);
        }
        data.add(PROTOCOL_VERSION_SUPPORTED, supportedVersions);
        return data;
    }
